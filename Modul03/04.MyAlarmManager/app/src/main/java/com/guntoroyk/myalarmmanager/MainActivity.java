package com.guntoroyk.myalarmmanager;
...
import com.guntoroyk.myalarmmanager.utils.DatePickerFragment;
import com.guntoroyk.myalarmmanager.utils.TimePickerFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvRepeatingAlarm = findViewById(R.id.tv_repeating_time);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_set_repeating_alarm:
                String repeatTime = tvRepeatingAlarm.getText().toString();
    ...
    public void onDialogTimeSet(String tag, int hourOfDay, int minute) {
        ...
        switch (tag) {
            ...
            case TIME_PICKER_REPEAT_TAG:
                tvRepeatingAlarm.setText(dateFormat.format(calendar.getTime()));
                break;
            default:
                break;
        }
